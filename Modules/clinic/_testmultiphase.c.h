...
_testmultiphase_StateAccessType_increment_count_clinic(StateAccessTypeObject *self, PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
        .format = "|i$p:increment_count_clinic",
        .kwtuple = KWTUPLE,
    };
    #undef KWTUPLE
    int n = 1;
...
/*[clinic end generated code: output=d0c6055a85c9c78e input=a9049054013a1b77]*/
